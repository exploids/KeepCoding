...
void setup() {
  ...
  dragSound = new SoundFile(this, PREFIX + "drag.mp3");
  dropSound = new SoundFile(this, PREFIX + "drop.mp3");
  solveSound = new SoundFile(this, PREFIX + "solve.mp3");
  collideSound = new SoundFile(this, PREFIX + "collide.mp3");
  things = new Thing[10];
